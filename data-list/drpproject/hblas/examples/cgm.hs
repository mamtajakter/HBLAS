...
conjugateGradient :: (Num n, Fractional n, Ord n, Floating n) => [[n]] -> [n] -> [n]  -> [n] 
...
main = do putStr "\n\nCGM:\n"
          ...
          putStrLn $ "Discard Test : " ++ (show (((diffUTCTime t8 t7) +   (diffUTCTime t6 t5)+   (diffUTCTime t5 t0)) *1000000/8))
          putStrLn $ "Discard Test : " ++ (show (((diffUTCTime t11 t10)  +  (diffUTCTime t9 t0)) *1000000/8))

          putStrLn $ "Discard Test : " ++ (show (( (diffUTCTime t14 t13)+ (diffUTCTime t12 t0)) *1000000/8))
