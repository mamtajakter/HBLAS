...
main = do putStr "\n\nCGM 05:\n"
          let alpha, beta :: Float
              ...
              vecX = createVecX' 21840
              vecY = createVec0 21840
              a = createVecX' (21840^2)
          ...
          t0 <- getCurrentTime
          t1 <- deepseq (conjugateGradient 21840 a vecX vecY) getCurrentTime
          t2 <- deepseq (conjugateGradient 21840 a vecX vecY) getCurrentTime
          t3 <- deepseq (conjugateGradient 21840 a vecX vecY) getCurrentTime
