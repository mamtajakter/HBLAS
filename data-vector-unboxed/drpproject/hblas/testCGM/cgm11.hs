...
main = do putStr "\n\nCGM 11:\n"
          ...
          t0 <- getCurrentTime
          t1 <- deepseq (conjugateGradient 53110 a vecX vecY) getCurrentTime
          t2 <- deepseq (conjugateGradient 53110 a vecX vecY) getCurrentTime
          t3 <- deepseq (conjugateGradient 53110 a vecX vecY) getCurrentTime
