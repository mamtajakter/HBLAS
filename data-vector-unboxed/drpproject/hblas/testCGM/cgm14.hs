...
main = do putStr "\n\nCGM 14:\n"
          let alpha, beta :: Float
              ...
              vecX = createVecX' 68740
              vecY = createVec0 68740
              a = createVecX' (68740^2)
          ...
          t0 <- getCurrentTime
          t1 <- deepseq (conjugateGradient 68740 a vecX vecY) getCurrentTime
          t2 <- deepseq (conjugateGradient 68740 a vecX vecY) getCurrentTime
          t3 <- deepseq (conjugateGradient 68740 a vecX vecY) getCurrentTime
