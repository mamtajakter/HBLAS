...
main = do putStr "\n\nCGM 06:\n"
          let alpha, beta :: Float
              ...
              vecY = createVec0 27050
              a = createVecX' (27050^2)
          ...
          t0 <- getCurrentTime
          t1 <- deepseq (conjugateGradient 27050 a vecX vecY) getCurrentTime
          t2 <- deepseq (conjugateGradient 27050 a vecX vecY) getCurrentTime
          t3 <- deepseq (conjugateGradient 27050 a vecX vecY) getCurrentTime
