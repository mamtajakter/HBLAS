...
main = do putStr "\n\nCGM 12:\n"
          ...
          t0 <- getCurrentTime
          t1 <- deepseq (conjugateGradient 58320 a vecX vecY) getCurrentTime
          t2 <- deepseq (conjugateGradient 58320 a vecX vecY) getCurrentTime
          t3 <- deepseq (conjugateGradient 58320 a vecX vecY) getCurrentTime
