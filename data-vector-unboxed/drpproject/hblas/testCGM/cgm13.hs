...
main = do putStr "\n\nCGM 13:\n"
          ...
          t0 <- getCurrentTime
          t1 <- deepseq (conjugateGradient 63530 a vecX vecY) getCurrentTime
          t2 <- deepseq (conjugateGradient 63530 a vecX vecY) getCurrentTime
          t3 <- deepseq (conjugateGradient 63530 a vecX vecY) getCurrentTime
