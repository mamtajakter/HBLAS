...
main = do putStr "\n\nCGM 08:\n"
          ...
          t0 <- getCurrentTime
          t1 <- deepseq (conjugateGradient 37470 a vecX vecY) getCurrentTime
          t2 <- deepseq (conjugateGradient 37470 a vecX vecY) getCurrentTime
          t3 <- deepseq (conjugateGradient 37470 a vecX vecY) getCurrentTime
