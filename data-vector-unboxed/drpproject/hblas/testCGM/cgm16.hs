...
main = do putStr "\n\nCGM 16:\n"
          ...
          t0 <- getCurrentTime
          t1 <- deepseq (conjugateGradient 79160 a vecX vecY) getCurrentTime
          t2 <- deepseq (conjugateGradient 79160 a vecX vecY) getCurrentTime
          t3 <- deepseq (conjugateGradient 79160 a vecX vecY) getCurrentTime
