...
main = do putStr "\n\nCGM 20:\n"
          ...
          t0 <- getCurrentTime
          t1 <- deepseq (conjugateGradient 100000 a vecX vecY) getCurrentTime
          t2 <- deepseq (conjugateGradient 100000 a vecX vecY) getCurrentTime
          t3 <- deepseq (conjugateGradient 100000 a vecX vecY) getCurrentTime
