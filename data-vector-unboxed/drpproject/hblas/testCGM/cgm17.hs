...
main = do putStr "\n\nCGM 17:\n"
          let alpha, beta :: Float
              ...
              vecX = createVecX' 84370
              vecY = createVec0 84370
              a = createVecX' (84370^2)
          ...
          t0 <- getCurrentTime
          t1 <- deepseq (conjugateGradient 84370 a vecX vecY) getCurrentTime
          t2 <- deepseq (conjugateGradient 84370 a vecX vecY) getCurrentTime
          t3 <- deepseq (conjugateGradient 84370 a vecX vecY) getCurrentTime
