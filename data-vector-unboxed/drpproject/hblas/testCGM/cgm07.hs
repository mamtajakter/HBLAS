...
main = do putStr "\n\nCGM 07:\n"
          let alpha, beta :: Float
              ...
              vecX = createVecX' 32260 
              vecY = createVec0 32260
              a = createVecX' (32260^2)
          ...
          t0 <- getCurrentTime
          t1 <- deepseq (conjugateGradient 32260 a vecX vecY) getCurrentTime
          t2 <- deepseq (conjugateGradient 32260 a vecX vecY) getCurrentTime
          t3 <- deepseq (conjugateGradient 32260 a vecX vecY) getCurrentTime
