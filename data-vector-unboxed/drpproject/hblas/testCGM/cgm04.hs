...
main = do putStr "\n\nCGM 04:\n"
          ...
          t0 <- getCurrentTime
          t1 <- deepseq (conjugateGradient 16630 a vecX vecY) getCurrentTime
          t2 <- deepseq (conjugateGradient 16630 a vecX vecY) getCurrentTime
          t3 <- deepseq (conjugateGradient 16630 a vecX vecY) getCurrentTime
