...
main = do putStr "\n\nCGM 09:\n"
          let alpha, beta :: Float
              ...
              vecX = createVecX' 42680
              vecY = createVec0 42680
              a = createVecX' (42680^2)
          ...
          t0 <- getCurrentTime
          t1 <- deepseq (conjugateGradient 42680 a vecX vecY) getCurrentTime
          t2 <- deepseq (conjugateGradient 42680 a vecX vecY) getCurrentTime
          t3 <- deepseq (conjugateGradient 42680 a vecX vecY) getCurrentTime
