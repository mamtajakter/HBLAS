...
main = do putStr "\n\nCGM 01:\n"
          ...
          t0 <- getCurrentTime
          t1 <- deepseq (conjugateGradient 1000 a vecX vecY) getCurrentTime
          t2 <- deepseq (conjugateGradient 1000 a vecX vecY) getCurrentTime
          t3 <- deepseq (conjugateGradient 1000 a vecX vecY) getCurrentTime
