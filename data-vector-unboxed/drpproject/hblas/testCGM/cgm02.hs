...
main = do putStr "\n\nCGM 02:\n"
          let alpha, beta :: Float
              ...
              vecX = createVecX' 6210
              vecY = createVec0 6210
              a = createVecX' (6210^2)
          ...
          t0 <- getCurrentTime
          t1 <- deepseq (conjugateGradient 6210 a vecX vecY) getCurrentTime
          t2 <- deepseq (conjugateGradient 6210 a vecX vecY) getCurrentTime
          t3 <- deepseq (conjugateGradient 6210 a vecX vecY) getCurrentTime
