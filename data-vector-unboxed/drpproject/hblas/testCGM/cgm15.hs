...
main = do putStr "\n\nCGM 15:\n"
          ...
          t0 <- getCurrentTime
          t1 <- deepseq (conjugateGradient 73950 a vecX vecY) getCurrentTime
          t2 <- deepseq (conjugateGradient 73950 a vecX vecY) getCurrentTime
          t3 <- deepseq (conjugateGradient 73950 a vecX vecY) getCurrentTime
