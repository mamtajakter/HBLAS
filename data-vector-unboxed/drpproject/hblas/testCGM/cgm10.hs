...
main = do putStr "\n\nCGM 10:\n"
          ...
          t0 <- getCurrentTime
          t1 <- deepseq (conjugateGradient 47890 a vecX vecY) getCurrentTime
          t2 <- deepseq (conjugateGradient 47890 a vecX vecY) getCurrentTime
          t3 <- deepseq (conjugateGradient 47890 a vecX vecY) getCurrentTime
