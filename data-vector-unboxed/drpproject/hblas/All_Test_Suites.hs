...
test-suite tfqmr_01_03
   ...
   type:                exitcode-stdio-1.0
   default-language:    Haskell2010
   main-is:             examples/testTFQMR_01_03.hs
   build-depends:       base,
                        vector,
                        hblas,
                        time >= 1.6

test-suite tfqmr_04_06
   ghc-options:         -O2
                        -threaded
                        -eventlog
                        -rtsopts
   type:                exitcode-stdio-1.0
   default-language:    Haskell2010
   main-is:             examples/testTFQMR_04_06.hs
   build-depends:       base,
                        vector,
                        hblas,
                        time >= 1.6

test-suite tfqmr_07_08
   ghc-options:         -O2
                        -threaded
                        -eventlog
                        -rtsopts
   type:                exitcode-stdio-1.0
   default-language:    Haskell2010
   main-is:             examples/testTFQMR_07_08.hs
   build-depends:       base,
                        vector,
                        hblas,
                        time >= 1.6
...
test-suite tfqmr_09
   ...
   type:                exitcode-stdio-1.0
   default-language:    Haskell2010
   main-is:             examples/testTFQMR_09.hs
   build-depends:       base,
                        vector,
                        hblas,
                        time >= 1.6
