...
main = do putStr "\n\nCGM 01-09:\n"
          ...
          t0 <- getCurrentTime
          t1 <- seq (conjugateGradient (2^1) a1 vecX1 vecY1) getCurrentTime
          t2 <- seq (conjugateGradient (2^1) a1 vecX1 vecY1) getCurrentTime
          t3 <- seq (conjugateGradient (2^1) a1 vecX1 vecY1) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) /r))       
          t0 <- getCurrentTime
          t1 <- seq (conjugateGradient (2^2) a2 vecX2 vecY2) getCurrentTime
          t2 <- seq (conjugateGradient (2^2) a2 vecX2 vecY2) getCurrentTime
          t3 <- seq (conjugateGradient (2^2) a2 vecX2 vecY2) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) /r))          
          t0 <- getCurrentTime
          t1 <- seq (conjugateGradient (2^3) a3 vecX3 vecY3) getCurrentTime
          t2 <- seq (conjugateGradient (2^3) a3 vecX3 vecY3) getCurrentTime
          t3 <- seq (conjugateGradient (2^3) a3 vecX3 vecY3) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) /r))          
          t0 <- getCurrentTime
          t1 <- seq (conjugateGradient (2^4) a4 vecX4 vecY4) getCurrentTime
          t2 <- seq (conjugateGradient (2^4) a4 vecX4 vecY4) getCurrentTime
          t3 <- seq (conjugateGradient (2^4) a4 vecX4 vecY4) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) /r))
          t0 <- getCurrentTime
          t1 <- seq (conjugateGradient (2^5) a5 vecX5 vecY5) getCurrentTime
          t2 <- seq (conjugateGradient (2^5) a5 vecX5 vecY5) getCurrentTime
          t3 <- seq (conjugateGradient (2^5) a5 vecX5 vecY5) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) /r))          
          t0 <- getCurrentTime
          t1 <- seq (conjugateGradient (2^6) a6 vecX6 vecY6) getCurrentTime
          t2 <- seq (conjugateGradient (2^6) a6 vecX6 vecY6) getCurrentTime
          t3 <- seq (conjugateGradient (2^6) a6 vecX6 vecY6) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) /r))          
          t0 <- getCurrentTime
          t1 <- seq (conjugateGradient (2^7) a7 vecX7 vecY7) getCurrentTime
          t2 <- seq (conjugateGradient (2^7) a7 vecX7 vecY7) getCurrentTime
          t3 <- seq (conjugateGradient (2^7) a7 vecX7 vecY7) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) /r))          
          t0 <- getCurrentTime
          t1 <- seq (conjugateGradient (2^8) a8 vecX8 vecY8) getCurrentTime
          t2 <- seq (conjugateGradient (2^8) a8 vecX8 vecY8) getCurrentTime
          t3 <- seq (conjugateGradient (2^8) a8 vecX8 vecY8) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) /r))
          t0 <- getCurrentTime
          t1 <- seq (conjugateGradient (2^9) a9 vecX9 vecY9) getCurrentTime
          t2 <- seq (conjugateGradient (2^9) a9 vecX9 vecY9) getCurrentTime
          t3 <- seq (conjugateGradient (2^9) a9 vecX9 vecY9) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) /r)) 
