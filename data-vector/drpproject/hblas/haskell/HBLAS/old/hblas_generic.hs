...
dcopy xs ys | length xs == length ys = xs
            | otherwise              = error "Vector sizes must match"

daxpy :: (Zippable f, Num n) => n -> f n -> f n -> f n
daxpy alpha xs ys =
  case length xs == length ys of
    True -> zipWith (\x y -> y+alpha*x) xs ys
    False -> error "Vector sizes must match"
...
dznrm2 x =
  case x == mempty of
    True -> 0
    False -> let (ssq,scale) = foldr (\e (s,c) -> if c<(abs e)
...
idamax a =
  case a == mempty of
    True -> Nothing
    False -> elemIndex (maximum (fmap abs a)) (fmap abs a)

ida :: (Functor f, Num n) => f n -> f n
ida = fmap abs
...
f_6_7_if :: (Floating n, Ord n) => n -> n -> Bool
f_6_7_if d1 flag = d1 /=0 && ((d1<=rgamsq) || (d1>=gamsq)) && flag==0

f_6_7_else :: (Floating n, Ord n) => n -> n -> Bool
f_6_7_else d1 flag = d1 /=0 && ((d1<=rgamsq) || (d1>=gamsq)) && flag/=0

f_9_10_if :: (Floating n, Ord n) => n -> n -> Bool
f_9_10_if d2 flag = (d2 /=0) && ((abs d2 <= rgamsq) || (abs d2>=gamsq) )  && flag==0

f_9_10_else :: (Floating n, Ord n) =>  n -> n -> Bool
...
drotmg_d1 :: (Floating n, Ord n) => n -> n -> n -> n -> n -> n -> n -> n -> n -> n
...
drotmg_d2 :: (Floating n, Ord n) => n -> n -> n -> n -> n -> n -> n -> n -> n -> n
...
drotmg_x1 :: (Floating n, Ord n) => n -> n -> n -> n -> n -> n -> n -> n -> n -> n
...
drotmg_flag :: (Floating n, Ord n) => n -> n -> n -> n -> n -> n -> n -> n -> n -> n
...
drotmg_h11 :: (Floating n, Ord n) => n -> n -> n -> n -> n -> n -> n -> n -> n -> n
...
drotmg_h12 :: (Floating n, Ord n) => n -> n -> n -> n -> n -> n -> n -> n -> n -> n
...
drotmg_h21 :: (Floating n, Ord n) => n -> n -> n -> n -> n -> n -> n -> n -> n -> n
...
drotmg_h22 :: (Floating n, Ord n) => n -> n -> n -> n -> n -> n -> n -> n -> n -> n
