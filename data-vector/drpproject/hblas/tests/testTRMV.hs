...
main = do putStr "\n\nTRMV:\n"
          ...
          -- t0 <- getCurrentTime
          -- t15 <- seq (trmv a15 vecX15 vecY15 ) getCurrentTime
          -- t16 <- seq (trmv a16 vecX16 vecY16 ) getCurrentTime
          ...
          t0 <- getCurrentTime
          t1 <- seq (trmv a1 vecX1 'l' ) getCurrentTime
          t2 <- seq (trmv a1 vecX1 'l' ) getCurrentTime
          t3 <- seq (trmv a1 vecX1 'l' ) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) *1000000/r))       
          t0 <- getCurrentTime
          t1 <- seq (trmv a2 vecX2 'l' ) getCurrentTime
          t2 <- seq (trmv a2 vecX2 'l' ) getCurrentTime
          t3 <- seq (trmv a2 vecX2 'l' ) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) *1000000/r))          
          t0 <- getCurrentTime
          t1 <- seq (trmv a3 vecX3 'l' ) getCurrentTime
          t2 <- seq (trmv a3 vecX3 'l' ) getCurrentTime
          t3 <- seq (trmv a3 vecX3 'l' ) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) *1000000/r))          
          t0 <- getCurrentTime
          t1 <- seq (trmv a4 vecX4 'l' ) getCurrentTime
          t2 <- seq (trmv a4 vecX4 'l' ) getCurrentTime
          t3 <- seq (trmv a4 vecX4 'l' ) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) *1000000/r))
          t0 <- getCurrentTime
          t1 <- seq (trmv a5 vecX5 'l' ) getCurrentTime
          t2 <- seq (trmv a5 vecX5 'l' ) getCurrentTime
          t3 <- seq (trmv a5 vecX5 'l' ) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) *1000000/r))          
          t0 <- getCurrentTime
          t1 <- seq (trmv a6 vecX6 'l' ) getCurrentTime
          t2 <- seq (trmv a6 vecX6 'l' ) getCurrentTime
          t3 <- seq (trmv a6 vecX6 'l' ) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) *1000000/r))          
          t0 <- getCurrentTime
          t1 <- seq (trmv a7 vecX7 'l' ) getCurrentTime
          t2 <- seq (trmv a7 vecX7 'l' ) getCurrentTime
          t3 <- seq (trmv a7 vecX7 'l' ) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) *1000000/r))          
          t0 <- getCurrentTime
          t1 <- seq (trmv a8 vecX8 'l' ) getCurrentTime
          t2 <- seq (trmv a8 vecX8 'l' ) getCurrentTime
          t3 <- seq (trmv a8 vecX8 'l' ) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) *1000000/r))
          t0 <- getCurrentTime
          t1 <- seq (trmv a9 vecX9 'l' ) getCurrentTime
          t2 <- seq (trmv a9 vecX9 'l' ) getCurrentTime
          t3 <- seq (trmv a9 vecX9 'l' ) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) *1000000/r)) 


          t0 <- getCurrentTime
          t1 <- seq (trmv a10 vecX10 'l' ) getCurrentTime
          t2 <- seq (trmv a10 vecX10 'l' ) getCurrentTime
          t3 <- seq (trmv a10 vecX10 'l' ) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) *1000000/r))          
          t0 <- getCurrentTime
          t1 <- seq (trmv a11 vecX11 'l' ) getCurrentTime
          t2 <- seq (trmv a11 vecX11 'l' ) getCurrentTime
          t3 <- seq (trmv a11 vecX11 'l' ) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) *1000000/r))          
          t0 <- getCurrentTime
          t1 <- seq (trmv a12 vecX12 'l' ) getCurrentTime
          t2 <- seq (trmv a12 vecX12 'l' ) getCurrentTime
          t3 <- seq (trmv a12 vecX12 'l' ) getCurrentTime
          putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) *1000000/r))          
          

          -- t0 <- getCurrentTime
          -- t1 <- seq (trmv a13 vecX13 'l' ) getCurrentTime
          -- t2 <- seq (trmv a13 vecX13 'l' ) getCurrentTime
          -- t3 <- seq (trmv a13 vecX13 'l' ) getCurrentTime
          -- putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) *1000000/r))          
          -- t0 <- getCurrentTime
          -- t1 <- seq (trmv a14 vecX14 'l' ) getCurrentTime
          -- t2 <- seq (trmv a14 vecX14 'l' ) getCurrentTime
          -- t3 <- seq (trmv a14 vecX14 'l' ) getCurrentTime
          -- putStrLn $ (show  (((diffUTCTime t3 t2) + (diffUTCTime t2 t1) +(diffUTCTime t1 t0)) *1000000/r))
