...
{-# INLINE tfqmr #-}
tfqmr :: (Num n, Fractional n, Ord n, Floating n) => V.Vector (V.Vector n) -> V.Vector n ->V.Vector n -> n -> V.Vector n
...
main = do putStr "\n\nTFQMR 05-07:\n"
          ...
          putStrLn $ "Discard Test : " ++ (show ((   (diffUTCTime t7 t6)+   (diffUTCTime t5 t0)) /8))
